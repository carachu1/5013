...
def main():
    ...
    # load image
    img_path = "/hpc2hdd/home/cguo847/5013/cars_photo/Acura_RL_Sedan_2012/000001.jpg"
    ...
    # read class_indict
    json_path = '/hpc2hdd/home/cguo847/5013/fine-tuning-cars/class_indices.json'
    ...
    # create model
    model = create_model(num_classes=196).to(device)
    # load model weights
    model_weight_path = "/hpc2hdd/home/cguo847/weights/model-car-large.pth" # 
    # model.load_state_dict(torch.load(model_weight_path, map_location=device))
    model.eval()
    # load the pre-training weight
    state_dict = torch.load(model_weight_path, map_location=device)
    # filter out the weight of the classifier layer
    state_dict = {k: v for k, v in state_dict.items() if not k.startswith('head.classifier')}
    
    # Load other weights
    model.load_state_dict(state_dict, strict=False)
    
    # Reinitializes the classifier layer
