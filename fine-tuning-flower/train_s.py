...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/model-flower-small-batch512.pth".format(epoch))
...
# 绘制validation loss和accuracy的折线图
    ...
    plt.tight_layout()
    plt.savefig('validation_metrics_s_flower_batch512.png')
    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/hpc2hdd/home/cguo847/5013/pre_efficientnetv2-s.pth',
